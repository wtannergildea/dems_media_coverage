...
gt(joined_table) %>%
  tab_header(
    title = "How much has coverage changed between January and now?",
    subtitle = "January 6th to July 7th, 2019") %>% 
  
# Here I simply column names.
  
  cols_label("Jan. 6th Cable" = "Jan. 6",
